# components-flutter-consumer

Status: **contract-only**. This suite specifies external Flutter package consumption and separated public, customer, and administrator widgets.
